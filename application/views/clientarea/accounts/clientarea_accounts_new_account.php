...
<div class="box box-primary">
	<div class="box-header with-border">
    	...
    	<div class="topColPad">
    		<?php $this->load->view($this->data['modules'].'new_user'); ?>
    	</div>
    </div>
    <div class="box-footer">
    	<?php echo form_button(array('type' => 'submit', 'class' =>'btn btn-success pull-right', 'content' => '<i class="glyphicon glyphicon-user"></i> Create New User')); ?>
    </div>
</div>    
