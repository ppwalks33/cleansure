      		...
      		$c = count($previous_score);  
      			...
      			if(is_array($previous_score)): 
					...
					
					{
						...
						echo "<div class=\"col-xs-12 col-md-6 audit-scores\">\n";
						
						echo sprintf($this->lang->line('h4'), 'Last Score');
						
						echo "<ul class=\"profile-qa-scores\">\n";
						
						echo "<li>".$score[1][2]."% <span class=\"glyphicon glyphicon-circle-arrow-".($myScore[0] == true ? 'up up':'down down')."\"></span></li>\n";
						...
						if($c > 1)
					
							{
								...
								echo "<li>".$score[0][2]."% <span class=\"glyphicon glyphicon-circle-arrow-".($myScore[1] == true ? 'up up':'down down')."\"></span></li>\n";
        	    ...
        	    echo anchor('clientarea/specifications/qa/'.$customer_data[0]->site_id.'/'.$customer_data[0]->comp_id.'/', 
        	    
        	    			'<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Quality Audit', 
