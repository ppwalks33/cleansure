     <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  /* Uncomment if you want an attachement button */
                  /*
                  <div class="form-group">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <?php /* <button class="btn btn-default"><i class="fa fa-pencil"></i> Draft</button> */ ?>
                    <button type="submit" class="btn btn-success"><i class="fa fa-send-o"></i> Send</button>
                  </div>
                  <button class="btn btn-danger"><i class="fa fa-close"></i> Discard</button>
                </div><!-- /.box-footer -->
              </div><!-- /. box -->
